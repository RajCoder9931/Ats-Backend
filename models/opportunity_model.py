...
def _serialize_opportunity(doc):
    doc["_id"] = str(doc["_id"])
    if doc.get("leadId"):
...
def create_opportunity(data):
    try:
        ...
        opp = {
            ...
            "skillsRequired": data.get("skillsRequired") or [],
...
# ================= CREATE OPPORTUNITY FROM CONTRACT =================
def create_opportunity_from_contract(contract_id, created_by):
    try:
        ...
        opp["_id"] = str(result.inserted_id)
        return _serialize_opportunity(opp), None

    except InvalidId:
        return None, "Invalid contract id format"

    except Exception as e:
        print("Create Opportunity From Contract Error:", e)
...
def get_active_opportunities():
    try:
        ...
        return [_serialize_opportunity(doc) for doc in cursor]
    except Exception as e:
        print("Get Active Opportunities Error:", e)
        return []
...
def get_inactive_opportunities():
    try:
        ...
        print("Get Inactive Opportunities Error:", e)
        return []
